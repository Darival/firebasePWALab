  ...
  <div class="flex">
    <div class="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:max-w-full lg:w-1/2 lg:py-24 lg:px-12">
      <div class="xl:max-w-lg xl:ml-auto">
        <img class="h-10" :src="require(`@/assets/logo.svg`)" alt="Workcation">
        ...
        <div class="mt-4 sm:mt-6">
          <a href="#" class="inline-block px-5 py-3 rounded-lg shadow-lg bg-indigo-500 text-sm text-white uppercase tracking-wider font-semibold sm:text-base hover:bg-indigo-400 focus:bg-indigo-400 focus:outline-none focus:shadow-outline">Book your escape</a>
        </div>
      </div>
    </div>
