  ...
  <div class="home">
      ...
      >
        <div class="xl:max-w-lg xl:ml-auto">
          ...
          >
            ...
            <br class="hidden lg:inline" /><span class="text-brand-color"
          ...
          <div class="mt-4 sm:mt-6">
            <a href="#" class="btn bg-brand-color text-white shadow-lg sm:text-base"
              >Book your escape</a
            >
            <a href="#" class="ml-3 btn btn-gray sm:text-base">Learn More</a>
          </div>
        </div>
      </div>
    ...
    <div class="max-w-md sm:max-w-xl lg:max-w-6xl mx-auto px-8 lg:px-12 py-8">
      ...
      <p class="text-gray-600">
        ...
        omnis harum, perspiciatis possimus sint autem.
      </p>
